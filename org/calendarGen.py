...
actividades_abril_mayo = [
    ...
    ("4 de Abril", "Medidas CMP (IOMS) planta de compostaje"),
    ("9 de Abril", "Medidas CMP (IOMS+bolsasx10 a pie)"),
    ("10 de Abril", "Medidas CMP (IOMS+bolsasx10 a pie)\n-> Olfactometrias Odournet\n-> Cover clases de Javi"),
    ("11 de Abril", "Olfactometrias Odournet\n->Equipo IR GSS"),
    ("12 de Abril", "Semana Santa"),
